...
from app.domain.company.pipeline import CollectResult, collect, find_corp_candidates
...
class CompanyService:
    ...
    async def run_company_pipeline(self, company_name: str) -> CollectResult:
        ...
        Returns:
            pipeline.collect() 가 돌려주는 CollectResult 그대로.
